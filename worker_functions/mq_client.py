...
class MQClient:
    ...
    def mq_connect(self, heartbeat = 60, confirm_delivery = False):
        """
        Connect to message broker
        :param heartbeat: connection heartbeat interval (keepalive message to prevent disconnect) (default = 60)
        :param confirm_delivery: Make broker confirm that the message was published (default = False)
        """
    ...
    def mq_connect_retry(self, *, heartbeat = 60, max_retry = 0, retry_interval = 30, confirm_delivery = False):
        """
