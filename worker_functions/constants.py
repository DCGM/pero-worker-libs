...
# status groups (for worker watchdog)
STATUS_GROUP_RUNNING = [STATUS_PROCESSING, STATUS_IDLE]
STATUS_GROUP_FAILURE = [STATUS_PROCESSING_FAILED, STATUS_CONFIGURATION_FAILED, STATUS_MQ_CONNECTION_FAILED]
